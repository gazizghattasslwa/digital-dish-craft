...
import { ArrowRight, CheckCircle, Star, Users, Clock, Shield, TrendingUp, MessageSquare, Award } from "lucide-react";
export const SEOContent = () => {
  const benefits = ["No setup fees or monthly subscriptions", "Mobile-optimized responsive design", "Instant QR code generation", "Real-time menu updates", "Custom branding and colors", "Multi-language support", "Analytics and insights", "24/7 customer support"];
  const testimonials = [{
        ...
        <div className="container-fluid">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="order-2 lg:order-1">
              ...
              <Button size="lg" className="mt-8 btn-primary hover-lift rounded-full">
      ...
      <section className="section-padding bg-muted/30">
        <div className="container-fluid">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {testimonials.map((testimonial, index) => <Card key={index} className="shadow-card hover:shadow-warm transition-all duration-300 hover-lift">
      ...
      <section className="section-padding">
        <div className="container-fluid">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            {faqs.map((faq, index) => <Card key={index} className="shadow-card hover:shadow-warm transition-all duration-300">
                <CardContent className="p-6">
