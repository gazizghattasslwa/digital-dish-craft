    ...
    <section className="section-padding bg-background">
      <div className="container-fluid">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-foreground">Live Demo & Dashboard Previews</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
          ...
          <div className="lg:col-span-3">
                <Card className="shadow-lg">
                    ...
                    <CardContent>
                        <div className="relative h-[600px] w-full max-w-lg mx-auto bg-gray-100 rounded-lg p-4">
                            <div className="h-full w-full bg-white rounded-lg shadow-inner overflow-y-auto">
                                <div className="p-4">
                                <h3 className="text-2xl font-bold text-center mb-4">The Gourmet Place</h3>
                                <div>
                                    <h4 className="text-xl font-semibold mt-4 border-b pb-2">Appetizers</h4>
                                ...
                                <div>
                                    <h4 className="text-xl font-semibold mt-4 border-b pb-2">Main Courses</h4>
                                    <div className="flex justify-between py-2">
