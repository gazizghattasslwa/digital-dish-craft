...
export const NewTransformSection = () => {
  ...
  const benefits = ["Setup in 10 minutes", "No technical skills needed", "Free to start"];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            <Button size="lg" onClick={handleGetStarted} className="bg-primary text-primary-foreground hover:bg-primary/90 px-8 py-4 text-lg rounded-full">
              Start Building Your Menu →
            </Button>
            <Button variant="outline" size="lg" className="border-border px-8 py-4 text-lg rounded-full text-slate-50 bg-zinc-950 hover:bg-zinc-800">
              View Live Demo
            </Button>
          </div>
